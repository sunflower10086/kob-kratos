...
const OperationUserServiceGetUserInfo = "/kob_kratos.v1.UserService/GetUserInfo"
const OperationUserServiceLogin = "/kob_kratos.v1.UserService/Login"
const OperationUserServiceRegister = "/kob_kratos.v1.UserService/Register"
...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/api/user/account/register", _UserService_Register0_HTTP_Handler(srv))
	r.POST("/api/user/account/token", _UserService_Login0_HTTP_Handler(srv))
	r.GET("/api/user/account/info", _UserService_GetUserInfo0_HTTP_Handler(srv))
}
...
func (c *UserServiceHTTPClientImpl) Login(ctx context.Context, in *LoginRequest, opts ...http.CallOption) (*LoginResponse, error) {
	...
	pattern := "/api/user/account/token"
...
func (c *UserServiceHTTPClientImpl) Register(ctx context.Context, in *RegisterRequest, opts ...http.CallOption) (*RegisterResponse, error) {
	...
	pattern := "/api/user/account/register"
	path := binding.EncodeURL(pattern, in, false)
