...
// Validate checks the field values on UpdateBotResponse with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *UpdateBotResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateBotResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateBotResponseMultiError, or nil if none found.
func (m *UpdateBotResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateBotResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateBotResponseMultiError(errors)
	}

	return nil
}

// UpdateBotResponseMultiError is an error wrapping multiple validation errors
// returned by UpdateBotResponse.ValidateAll() if the designated constraints
// aren't met.
type UpdateBotResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateBotResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateBotResponseMultiError) AllErrors() []error { return m }

// UpdateBotResponseValidationError is the validation error returned by
// UpdateBotResponse.Validate if the designated constraints aren't met.
type UpdateBotResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateBotResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateBotResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateBotResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateBotResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateBotResponseValidationError) ErrorName() string {
	return "UpdateBotResponseValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateBotResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateBotResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateBotResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateBotResponseValidationError{}
...
// Validate checks the field values on DeleteBotResponse with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *DeleteBotResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on DeleteBotResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// DeleteBotResponseMultiError, or nil if none found.
func (m *DeleteBotResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *DeleteBotResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return DeleteBotResponseMultiError(errors)
	}

	return nil
}

// DeleteBotResponseMultiError is an error wrapping multiple validation errors
// returned by DeleteBotResponse.ValidateAll() if the designated constraints
// aren't met.
type DeleteBotResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m DeleteBotResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m DeleteBotResponseMultiError) AllErrors() []error { return m }

// DeleteBotResponseValidationError is the validation error returned by
// DeleteBotResponse.Validate if the designated constraints aren't met.
type DeleteBotResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e DeleteBotResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e DeleteBotResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e DeleteBotResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e DeleteBotResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e DeleteBotResponseValidationError) ErrorName() string {
	return "DeleteBotResponseValidationError"
}

// Error satisfies the builtin error interface
func (e DeleteBotResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sDeleteBotResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = DeleteBotResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = DeleteBotResponseValidationError{}
